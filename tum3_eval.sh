...
do
    ...
    echo $tmp
     ./Examples/RGB-D/rgbd_tum ./Vocabulary/ORBvoc.txt ./Examples/RGB-D/TUM3.yaml "$dataset"/rgbd_dataset_freiburg3_walking_xyz "$dataset"/rgbd_dataset_freiburg3_walking_xyz/associations.txt ../Mask_RCNN $result/output_$count
    ...
    tmp="$result"/fr3_walk_static/
     ./Examples/RGB-D/rgbd_tum ./Vocabulary/ORBvoc.txt ./Examples/RGB-D/TUM3.yaml "$dataset"/rgbd_dataset_freiburg3_walking_static "$dataset"/rgbd_dataset_freiburg3_walking_static/associations.txt  ../Mask_RCNN $result/output_$count
    ...
    tmp="$result"/fr3_walk_rpy/
     ./Examples/RGB-D/rgbd_tum ./Vocabulary/ORBvoc.txt ./Examples/RGB-D/TUM3.yaml "$dataset"/rgbd_dataset_freiburg3_walking_rpy "$dataset"/rgbd_dataset_freiburg3_walking_rpy/associations.txt ../Mask_RCNN $result/output_$count
    ...
    tmp="$result"/fr3_walk_halfsphere/
     ./Examples/RGB-D/rgbd_tum ./Vocabulary/ORBvoc.txt ./Examples/RGB-D/TUM3.yaml "$dataset"/rgbd_dataset_freiburg3_walking_halfsphere "$dataset"/rgbd_dataset_freiburg3_walking_halfsphere/associations.txt ../Mask_RCNN $result/output_$count
    ...
    tmp="$result"/fr3_sitting_static/
     ./Examples/RGB-D/rgbd_tum ./Vocabulary/ORBvoc.txt ./Examples/RGB-D/TUM3.yaml "$dataset"/rgbd_dataset_freiburg3_sitting_static "$dataset"/rgbd_dataset_freiburg3_sitting_static/associations.txt ../Mask_RCNN $result/output_$count
